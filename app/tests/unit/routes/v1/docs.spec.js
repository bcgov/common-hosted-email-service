...
describe(`GET ${basePath}`, () => {
  it('should return a redoc html page', async () => {
    ...
    expect(response.text).toContain('<title>Common Hosted Email Service API - Documentation');
  });
});
...
describe(`GET ${basePath}/api-spec.yaml`, () => {
  it('should return the OpenAPI spec in yaml', async () => {
    ...
    expect(response.text).toContain('title: Common Hosted Email Service API');
  });
});
...
describe(`GET ${basePath}/api-spec.json`, () => {
  it('should return the OpenAPI spec in json', async () => {
    ...
    expect(response.body.info.title).toMatch('Common Hosted Email Service API');
  });
});
